...
class FacePerceiverResamplerImport(torch.nn.Module):
    def __init__(
        self,
        *,
        dim=768,
...
class MLPProjModelFaceIdImport(torch.nn.Module):
...
class ProjModelFaceIdPlusImport(torch.nn.Module):
...
class IPAdapterTilesMaskedImport(IPAdapterApplyImport):
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class IPAdapterApplyFaceIDImport(IPAdapterApplyImport):
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class PrepImageForInsightFaceImport:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
            "image": ("IMAGE",),
...
class IPAdapterApplyEncodedImport(IPAdapterApplyImport):
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class IPAdapterSaveEmbedsImport:
    def __init__(self):
...
class IPAdapterLoadEmbedsImport:
    @classmethod
    def INPUT_TYPES(s):
